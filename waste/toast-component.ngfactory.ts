...
export class Wrapper_Toast {
  ...
  constructor(p0:any,p1:any,p2:any,p3:any) {
    this._changed = false;
    this.context = new import0.Toast(p0,p1,p2,p3);
...
class View_Toast_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._Toast_0_3 = new Wrapper_Toast(this.injectorGet(import9.ToastrService,this.parentIndex),this.injectorGet(import10.ToastData,this.parentIndex),this.injectorGet(import11.ToastRef,this.parentIndex),this.injectorGet(import12.DomSanitizer,this.parentIndex));
    this.compView_0.create(this._Toast_0_3.context);
    var disposable_0:Function = import3.subscribeToRenderElement(this,this._el_0,new import3.InlineArray8(6,'click',(null as any),'mouseleave',(null as any),'mouseenter',(null as any)),this.eventHandler(this.handleEvent_0));
...
;
function Toast_flyInOut_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import13.AnimationTransition {
...
class View_Toast3 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import3.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this.renderer.setElementProperty(this._el_0,'innerHTML',this.viewUtils.sanitizer.sanitize(import20.SecurityContext.HTML,currVal_3));
      this._expr_3 = currVal_3;
    }
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
...
class View_Toast5 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import3.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this.renderer.setElementStyle(this._el_2,'width',((this.viewUtils.sanitizer.sanitize(import20.SecurityContext.STYLE,currVal_4) == null)? (null as any): (this.viewUtils.sanitizer.sanitize(import20.SecurityContext.STYLE,currVal_4).toString() + '%')));
      this._expr_4 = currVal_4;
    }
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
...
export class View_Toast0 extends import2.AppView<import0.Toast> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._vc_3 = new import19.ViewContainer(3,(null as any),this,this._anchor_3);
    ...
    this._vc_5 = new import19.ViewContainer(5,(null as any),this,this._anchor_5);
    ...
    this._vc_7 = new import19.ViewContainer(7,(null as any),this,this._anchor_7);
    ...
    this._vc_9 = new import19.ViewContainer(9,(null as any),this,this._anchor_9);
