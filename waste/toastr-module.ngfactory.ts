...
import * as import17 from './overlay/overlay-container';
import * as import18 from './overlay/overlay';
import * as import19 from './toastr-service';
import * as import20 from '@angular/core/src/di/injector';
import * as import21 from './toast-component.ngfactory';
...
import * as import36 from './toastr-config';
class ToastrModuleInjector extends import0.NgModuleInjector<import1.ToastrModule> {
  ...
  _ToastrModule_3:import1.ToastrModule;
  __LOCALE_ID_4:any;
  ...
  __OverlayContainer_28:import17.OverlayContainer;
  __ToastConfig_29:any;
  __ToastrConfig_30:any;
  __Overlay_31:import18.Overlay;
  __ToastrService_32:import19.ToastrService;
  constructor(parent:import20.Injector) {
    super(parent,[import21.ToastNgFactory],([] as any[]));
  }
  ...
  get _APP_ID_12():any {
    if ((this.__APP_ID_12 == null)) { (this.__APP_ID_12 = import22._appIdRandomProviderFactory()); }
  ...
  get _EventManager_16():import11.EventManager {
    if ((this.__EventManager_16 == null)) { (this.__EventManager_16 = new import11.EventManager(this._EVENT_MANAGER_PLUGINS_15,this.parent.get(import25.NgZone))); }
  ...
  get _RootRenderer_20():any {
    if ((this.__RootRenderer_20 == null)) { (this.__RootRenderer_20 = import26._createConditionalRootRenderer(this._DomRootRenderer_19,this.parent.get(import26.NgProbeToken,(null as any)))); }
  ...
  get _OverlayContainer_28():import17.OverlayContainer {
    if ((this.__OverlayContainer_28 == null)) { (this.__OverlayContainer_28 = new import17.OverlayContainer()); }
    return this.__OverlayContainer_28;
  }
  get _ToastConfig_29():any {
    if ((this.__ToastConfig_29 == null)) { (this.__ToastConfig_29 = import1.ToastConfigFactory()); }
    return this.__ToastConfig_29;
  }
  get _ToastrConfig_30():any {
    if ((this.__ToastrConfig_30 == null)) { (this.__ToastrConfig_30 = import1.ToastrConfigFactory()); }
    return this.__ToastrConfig_30;
  }
  get _Overlay_31():import18.Overlay {
    if ((this.__Overlay_31 == null)) { (this.__Overlay_31 = new import18.Overlay(this._OverlayContainer_28,this,this._ApplicationRef_10,this)); }
    return this.__Overlay_31;
  }
  get _ToastrService_32():import19.ToastrService {
    if ((this.__ToastrService_32 == null)) { (this.__ToastrService_32 = new import19.ToastrService(this._ToastrConfig_30,this._Overlay_31)); }
    return this.__ToastrService_32;
  }
  createInternal():import1.ToastrModule {
    ...
    this._ToastrModule_3 = new import1.ToastrModule();
    ...
    this._Testability_8 = new import7.Testability(this.parent.get(import25.NgZone));
    this._ApplicationRef__9 = new import8.ApplicationRef_(this.parent.get(import25.NgZone),this.parent.get(import27.Console),this,this._ErrorHandler_6,this,this._ApplicationInitStatus_7,this.parent.get(import7.TestabilityRegistry,(null as any)),this._Testability_8);
    return this._ToastrModule_3;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.ToastrModule)) { return this._ToastrModule_3; }
    if ((token === import28.LOCALE_ID)) { return this._LOCALE_ID_4; }
    if ((token === import5.NgLocalization)) { return this._NgLocalization_5; }
    if ((token === import29.ErrorHandler)) { return this._ErrorHandler_6; }
    ...
    if ((token === import22.APP_ID)) { return this._APP_ID_12; }
    if ((token === import30.DOCUMENT)) { return this._DOCUMENT_13; }
    ...
    if ((token === import31.AnimationDriver)) { return this._AnimationDriver_18; }
    if ((token === import13.DomRootRenderer)) { return this._DomRootRenderer_19; }
    if ((token === import32.RootRenderer)) { return this._RootRenderer_20; }
    if ((token === import14.DomSanitizer)) { return this._DomSanitizer_21; }
    if ((token === import33.Sanitizer)) { return this._Sanitizer_22; }
    if ((token === import15.ViewUtils)) { return this._ViewUtils_23; }
    if ((token === import34.IterableDiffers)) { return this._IterableDiffers_24; }
    if ((token === import35.KeyValueDiffers)) { return this._KeyValueDiffers_25; }
    if ((token === import12.SharedStylesHost)) { return this._SharedStylesHost_26; }
    if ((token === import16.Title)) { return this._Title_27; }
    if ((token === import17.OverlayContainer)) { return this._OverlayContainer_28; }
    if ((token === import36.ToastConfig)) { return this._ToastConfig_29; }
    if ((token === import36.ToastrConfig)) { return this._ToastrConfig_30; }
    if ((token === import18.Overlay)) { return this._Overlay_31; }
    if ((token === import19.ToastrService)) { return this._ToastrService_32; }
