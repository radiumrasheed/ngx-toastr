(function (global, factory) {
    ...
    (factory((global.toastrng2 = global.toastrng2 || {}),global.ng.core,global._angular_common,global._angular_platformBrowser));
...
var MdNullPortalError = (function (_super) {
    __extends$1(MdNullPortalError, _super);
...
var MdPortalAlreadyAttachedError = (function (_super) {
    __extends$1(MdPortalAlreadyAttachedError, _super);
...
var MdPortalHostAlreadyDisposedError = (function (_super) {
    __extends$1(MdPortalHostAlreadyDisposedError, _super);
...
var MdNullPortalHostError = (function (_super) {
    __extends$1(MdNullPortalHostError, _super);
...
var MdNoPortalAttachedError = (function (_super) {
    __extends$1(MdNoPortalAttachedError, _super);
...
var TemplatePortal = (function (_super) {
    ...
    TemplatePortal.prototype.attach = function (host, newestOnTop, locals) {
        this.locals = locals == null ? new Map() : locals;
        return _super.prototype.attach.call(this, host, newestOnTop);
    };
...
var ToastConfig = (function () {
    function ToastConfig(config) {
        ...
        this.onHidden = new _angular_core.EventEmitter();
        this.onShown = new _angular_core.EventEmitter();
        this.onTap = new _angular_core.EventEmitter();
...
var ToastrService = (function () {
    ...
    ToastrService.prototype._buildNotification = function (type, message, title, optionsOverride) {
        ...
        var component = new ComponentPortal(optionsOverride.toastComponent);
        var ins = {
            toastId: this.index++,
            message: message,
...
var ToastrModule = (function () {
    ...
    ToastrModule.decorators = [
        { type: _angular_core.NgModule, args: [{
                    imports: [_angular_platformBrowser.BrowserModule, _angular_common.CommonModule],
                    exports: [Toast],
                    declarations: [Toast],
