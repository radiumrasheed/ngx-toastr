import { Component, trigger, state, transition, animate, style, HostBinding, HostListener } from '@angular/core';
import { DomSanitizer } from '@angular/platform-browser';
import { ToastData } from './toastr-config';
import { ToastrService } from './toastr-service';
import { ToastRef } from './toast-injector';
export var Toast = (function () {
    function Toast(toastrService, data, toastRef, sanitizer) {
        var _this = this;
