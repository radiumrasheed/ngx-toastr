...
import * as import10 from '@angular/core/src/animation/animation_style_util';
...
export class Wrapper_Toast {
  ...
  ngOnDetach(view:import2.AppView<any>,componentView:import2.AppView<any>,el:any):void {
    var animationTransition_flyInOut:any = componentView.componentType.animations['flyInOut'](view,el,this._expr_0,'void');
  ...
  checkHost(view:import2.AppView<any>,componentView:import2.AppView<any>,el:any,throwOnChange:boolean):void {
    const currVal_0:any = this.context.state;
    if (import3.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      var animationTransition_flyInOut:any = componentView.componentType.animations['flyInOut'](view,el,((this._expr_0 == import1.UNINITIALIZED)? 'void': this._expr_0),((currVal_0 == import1.UNINITIALIZED)? 'void': currVal_0));
      animationTransition_flyInOut.onStart((this._eventHandler || import3.noop).bind(view,'@flyInOut.start'));
      animationTransition_flyInOut.onDone((this._eventHandler || import3.noop).bind(view,'@flyInOut.done'));
      this._expr_0 = currVal_0;
    }
    const currVal_1:any = this.context.toastClasses;
...
function Toast_flyInOut_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import9.AnimationTransition {
  view.animationContext.cancelActiveAnimation(element,'flyInOut',(nextState == 'void'));
  ...
  import10.renderStyles(element,view.renderer,import10.clearStyles(startStateStyles));
  if (((player == (null as any)) && (((currentState == 'inactive') && (nextState == 'active')) || ((currentState == 'active') && (nextState == 'inactive'))))) {
      player = new import11.AnimationSequencePlayer([view.renderer.animate(element,new import12.AnimationStyles(import10.collectAndResolveStyles(collectedStyles,[startStateStyles])),import10.balanceAnimationKeyframes(collectedStyles,endStateStyles,[
        new import13.AnimationKeyframe(0,new import12.AnimationStyles(import10.collectAndResolveStyles(collectedStyles,[{}]))),
        new import13.AnimationKeyframe(1,new import12.AnimationStyles(import10.collectAndResolveStyles(collectedStyles,[{}])))
      ]
    ),300,0,'ease-in')]);
    totalTime = 300;
  }
  ...
  player.onDone(():void => {
    player.destroy();
    import10.renderStyles(element,view.renderer,import10.prepareFinalAnimationStyles(startStateStyles,endStateStyles));
  });
...
class View_Toast2 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_4:any = import3.inlineInterpolate(1,'',this.parentView.context.title,'');
